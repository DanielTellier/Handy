...
pub fn run(cli_args: CliArgs) {
    ...
    let specta_builder = Builder::<tauri::Wry>::new().commands(collect_commands![
        ...
        shortcut::update_spoken_symbols,
        shortcut::change_spoken_symbols_enabled_setting,
        shortcut::change_strip_trailing_period_setting,
        shortcut::change_no_auto_capitalize_setting,
